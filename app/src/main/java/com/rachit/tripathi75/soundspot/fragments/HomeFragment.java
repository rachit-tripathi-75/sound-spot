...
//        binding.ivAppLogo.startAnimation(slideUp);
    ...
    private void setupRecyclerViews() {
        ...
        binding.rvArtists.setLayoutManager(artistLayoutManager);
        ...
        binding.rvArtists.setLayoutAnimation(AnimationUtils.loadLayoutAnimation(requireContext(), R.anim.layout_animation_slide_right));
        binding.rvArtists.scheduleLayoutAnimation();

        // Setup Playlists RecyclerView
        GridLayoutManager playlistLayoutManager = new GridLayoutManager(requireContext(), 2);
        binding.rvPlaylists.setLayoutManager(playlistLayoutManager);
